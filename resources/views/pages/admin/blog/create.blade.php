...
<div class="form-w3layouts">
    <h2 class="page-title">Thêm Bài viết<br><br></h2>
    <form action="{{route('blog.create.submit')}}" method="post" enctype="multipart/form-data">
        @csrf
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="text" name="title_vi" size="100%" autofocus
